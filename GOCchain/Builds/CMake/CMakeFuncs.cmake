# This is a set of common functions and settings for GOCd
...
macro(use_protobuf)
  ...
  file(GLOB GOC_proto src/GOC/proto/*.proto)
  PROTOBUF_GENERATE_CPP(PROTO_SRCS PROTO_HDRS ${GOC_proto})

  if (WIN32)
    include_directories(src/protobuf/src
      src/protobuf/vsprojects
      ${CMAKE_CURRENT_BINARY_DIR}/src/GOC/proto)
  endif()
...
macro(setup_build_boilerplate)
  ...
  # `GOC.pb.h`, generated from protobuf triggers some warnings
  ...
  if (static)
    ...
    # set_target_properties(GOC-libpp PROPERTIES LINK_SEARCH_START_STATIC 1)
    # set_target_properties(GOC-libpp PROPERTIES LINK_SEARCH_END_STATIC 1)
  endif()
  ...
  if (DEFINED dump_leaks_on_exit AND NOT dump_leaks_on_exit)
    add_definitions(-DGOC_DUMP_LEAKS_ON_EXIT=0)
  else ()
    add_definitions(-DGOC_DUMP_LEAKS_ON_EXIT=1)
  endif()
  ...
  if (verify_nodeobject_keys)
    add_definitions(-DGOC_VERIFY_NODEOBJECT_KEYS=1)
  endif()
  ...
  if (single_io_service_thread)
    add_definitions(-DGOC_SINGLE_IO_SERVICE_THREAD=1)
  endif()

  # use_rocksdb
  #    Controls whether or not the RocksDB database back-end is compiled into
  #    GOCd. RocksDB requires a relatively modern C++ compiler (tested with
  ...
  if (use_rocksdb)
    add_definitions(-DGOC_ROCKSDB_AVAILABLE=1)
  elseif(DEFINED use_rocksdb)
    add_definitions(-DGOC_ROCKSDB_AVAILABLE=0)
  endif()
