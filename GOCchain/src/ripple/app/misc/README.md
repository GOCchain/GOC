...
The GOC payment protocol enforces a fee schedule expressed in units of the
...
The GOC consensus algorithm allows distributed participants to arrive at
...
A validating instance of GOCd uses information in the configuration file
...
consensus to succeed, otherwise different instances of GOCd will get 
...
*  A pull request is created and the new code is folded into a GOCd build 
