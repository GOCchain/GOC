...
There are two ledgers that are the most important for a GOCd server to have:
...
A distributed agreement protocol. GOC uses the consensus process to solve
...
the transaction increments the sequence number.  This is how GOC prevents
...
**index:** 256-bit hash of this GOCState.
...
The GOC server permits clients to subscribe to a continuous stream of
