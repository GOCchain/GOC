...
GOC/basic should contain no dependencies on other modules.


Choosing a GOCd container.
=============================
...
* `std::unordered_set`
 * Use `GOC::hash_set` instead, which uses a better hashing algorithm.
 * Or use `GOC::hardened_hash_set` to prevent algorithmic complexity attacks.
