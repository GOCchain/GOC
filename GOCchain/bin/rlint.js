...
var Remote      = require('GOC-lib').Remote;
var Transaction = require('GOC-lib').Transaction;
var UInt160     = require('GOC-lib').UInt160;
var Amount      = require('GOC-lib').Amount;
...
//  console.log(JSON.stringify(dir_entry, undefined, 2));
  ...
  ledger.accountState.forEach(function (entry) {
      ...
      else if (entry.LedgerEntryType === 'GOCState')
      {
  ...
  if (Object.keys(GOC_selfs).length)
    console.log("GOCState selfs = %s", Object.keys(GOC_selfs).length);
